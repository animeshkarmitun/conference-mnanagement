<div class="space-y-6">
    ...
    @if($conferenceDoc)
        ...
        <div class="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-6 border border-yellow-200">
            <div class="flex items-center justify-between">
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 mb-2">Download Conference Docs</h4>
                ...
                <a href="{{ route('participant.conference-docs.download', $conferenceDoc) }}" 
    ...
    @else
        ...
        <div class="bg-gray-50 rounded-lg p-8 text-center">
            ...
            <h4 class="text-lg font-semibold text-gray-900 mb-2">Conference Docs Not Available</h4>
