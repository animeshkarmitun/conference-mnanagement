            ...
            <aside class="bg-white shadow-lg flex flex-col transition-all duration-300" :class="sidebarCollapsed ? 'w-16' : 'w-64'">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    @if(auth()->user()->hasRole('superadmin'))
                        ...
                        <a href="{{ route('users.index') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Users' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('roles.index') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Roles' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('bulk.email') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Bulk Email' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('gmail.index') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Gmail Conversations' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.travel-manifests') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Travel Manifests' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.export-manifest') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Export Manifest' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    @elseif(auth()->user()->hasRole('tasker'))
                        <a href="{{ route('dashboard.tasker') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Tasker Dashboard' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" d="M8 5a2 2 0 012-2h4a2 2 0 012 2v6H8V5z"/>
                            </svg>
                    ...
                    @elseif(auth()->user()->hasRole('event_coordinator'))
                        <a href="{{ route('event-coordinator.dashboard') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Event Coordinator Dashboard' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" d="M8 5a2 2 0 012-2h4a2 2 0 012 2v6H8V5z"/>
                            </svg>
                        ...
                        <div class="border-t border-gray-200 my-2"></div>
                        <div class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0' : 'opacity-100'">Travel Management</div>
                        <a href="{{ route('event-coordinator.travel-manifests') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Travel Manifests' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>
                            </svg>
                            <span class="transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0' : 'opacity-100'">Travel Manifests</span>
                        </a>
                        <a href="{{ route('event-coordinator.export-manifest') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-yellow-50 font-medium text-gray-800 group" :title="sidebarCollapsed ? 'Export Manifest' : ''">
                            <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            <span class="transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0' : 'opacity-100'">Export Manifest</span>
