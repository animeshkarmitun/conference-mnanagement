                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-yellow-600 border border-yellow-600 cursor-default leading-5 rounded-md shadow-lg">
                                            {{ $page }}
                                        </span>
                                    </span>
                                @else
